...
class ApplicationRowSerializer(serializers.Serializer):
    ...
    activity_provenance = serializers.JSONField()
    derivation_state = serializers.CharField()
    date_applied_mode = serializers.CharField()
    calendar_timezone = serializers.CharField()
