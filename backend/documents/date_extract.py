...
Bump DATE_EXTRACTOR_VERSION (and extraction.py's EXTRACTOR_VERSION, which
...
byte-for-byte from _app/date_extract.py -- pure text/regex logic, no
filesystem or framework dependency to change.
"""
