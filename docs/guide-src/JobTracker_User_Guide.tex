...
\textbf{Guide version:} 1.5 \quad | \quad \textbf{Updated:} August 26, 2026\par
\vspace{0.6cm}
...
\begin{warningbox}
\textbf{"App is damaged" or an unidentified-developer warning.} This is normal for an app downloaded outside the App Store and not notarized by Apple. Right-click (or Control-click) the app in \file{Applications}, choose \textbf{Open}, then confirm in the dialog that appears. You only need to do this once.
\end{warningbox}
