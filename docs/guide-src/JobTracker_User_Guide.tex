...
\textbf{Guide version:} 1.6 \quad | \quad \textbf{Updated:} August 26, 2026\par
\vspace{0.6cm}
...
\begin{infobox}
\textbf{First launch.} The very first time you open the app, it asks you to choose a folder — this becomes your tracker root, exactly like the \file{my-tracker/} folder in the command-line quick start above. Pick an empty folder for a fresh tracker, or an existing one if you're migrating from a manual install. The app remembers this choice and opens straight to your dashboard on every future launch.
\end{infobox}
